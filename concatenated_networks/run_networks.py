...
parser.add_argument('--save_dir', type=str, default='../results/concat_networks/_concat_original_pretrained_VarNet_alpha0.1',
...
parser.add_argument('--input', type=str, default='cg',
					help='input for VarNet: ifft, cg(10 iterations), landweber(50 iterations)')
